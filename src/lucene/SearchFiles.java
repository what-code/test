...
public class SearchFiles {
	...
	public static void main(String[] args1) throws Exception {
		...
		String[] args = new String[]{"-query", "成都", "-index",indexDir.getPath() };
		String usage = "Usage:\tjava org.apache.lucene.demo.SearchFiles [-index dir] [-field f] " +
		...
		System.out.println("index--->" + index + "--queries-->" + queries + "---field-->" + field);
		...
		while (true) {
			...
			System.out.println("Searching for: " + query.toString(field) + "----->" + queryString);
