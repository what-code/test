...
//					}
					...
					// 在这里可以给服务端发送信息哦
					String fullMessage = this.clientId + (message + new Date()) + "--ss-->";
	...
	public void read(SelectionKey key) throws IOException {
		int temp = this.count.incrementAndGet();
        ...
        System.out.println("CC客户端收到11信息：" + msg);  
        ...
        if(temp < 10){
	        String requestMsg = this.clientId + (message + new Date()) + "--ss-->";
	        ByteBuffer outBuffer = ByteBuffer.wrap(requestMsg.getBytes());  
