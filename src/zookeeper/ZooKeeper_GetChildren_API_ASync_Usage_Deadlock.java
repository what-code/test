...
/**
 * Title:ZooKeeper_GetChildren_API_ASync_Usage_Deadlock.java
 * 
 * Description:ZooKeeper_GetChildren_API_ASync_Usage_Deadlock.java
 * 
...
public class ZooKeeper_GetChildren_API_ASync_Usage_Deadlock implements Watcher {
	...
	void getChildren(String path) throws KeeperException, InterruptedException,
			IOException {
		...
		zk.getChildren(path, true, new AsyncCallback.Children2Callback() {
			...
			public void processResult(int rc, String path, Object ctx,
				...
				System.out
						.println("Get Children znode result: [response code: "
								+ rc + ", param path: " + path + ", ctx: "
